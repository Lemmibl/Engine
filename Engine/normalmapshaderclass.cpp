...
bool NormalMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Engine/normalmap.vsh", L"../Engine/normalmap.psh");
	if(!result)
	{
		return false;
	}
...
bool NormalMapShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, 
