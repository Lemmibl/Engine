...
//		}
//
//		public OctreeContainmentModes OctreeContainmentMode
//		{
//			get;
//			set;
//		}
...
//
//		protected int maxDepth = 3; //Depth defines how many times the original node splits. Every node splits into 8 new nodes. -> 8^6 = 262 144 nodes if fully split. Yeah.
//		protected int maxItems = 10; //How many items a node can contain before it splits.
//
...
//
//	/// <summary>
//	/// Interface to define objects that can be tested against bounding primitives
//	/// </summary>
