...
void FontClass::BuildVertexArray(void* vertices, char* sentence, float drawX, float drawY)
{
	...
	for(i=0; i<numLetters; i++)
	{
		...
		else
		{
			...
			vertexPtr[index].position = D3DXVECTOR3((drawX + font[letter].size), (drawY - 16), 0.0f);  // Bottom right.
			...
			vertexPtr[index].position = D3DXVECTOR3(drawX + font[letter].size, drawY, 0.0f);  // Top right.
