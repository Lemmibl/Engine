	...
	XMMATRIX* worldViewProjection, XMMATRIX* worldView, XMMATRIX* world, ID3D11ShaderResourceView** textures)
{
	...
	result = SetShaderParameters(deviceContext, worldViewProjection, worldView, world, textures);
	if(!result)
	{
		return false;
	}
...
bool VegetationShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX* worldViewProjection, XMMATRIX* worldView, XMMATRIX* world, ID3D11ShaderResourceView** textures)
{
	HRESULT result;
