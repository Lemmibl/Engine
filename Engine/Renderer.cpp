...
#pragma region Directional light initialization
	...
	XMStoreFloat4x4(&dirLight->Projection, XMMatrixOrthographicLH(60.0f, 60.0f, 1.0f, 150.0f)); //Generate orthogonal light projection matrix and store it as float4x4
